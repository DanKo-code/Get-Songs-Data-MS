...
func (mmuc *MusixMatchUseCase) GetSongData(ctx context.Context, groupName, songName string) (*dtos.GetSongDataResponse, error) {
	...
	getSongDataResponse := dtos.GetSongDataResponse{
		Ip:          songData.songIP,
		Link:        songData.link,
		ReleaseDate: releaseData.releaseDate,
		TrackName:   strings.ToLower(songData.trackName),
		ArtistName:  strings.ToLower(songData.artistName),
	}

	return &getSongDataResponse, nil
}
